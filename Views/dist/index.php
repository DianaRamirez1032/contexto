...
<body>
  ...
  <div>
    <div id="miniSidebar" class="sideBarOriginal">
      ...
      <ul class="navbar-nav flex-column">
        ...
        <!-- Contratos -->
        <li class="nav-item">
          <a class="nav-link" href="../src/pages/contratos.html">
            <span class="nav-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
        ...
        <!-- Blockchain -->
        <li class="nav-item">
          <a class="nav-link" href="../src/pages/blockchain.html">
            <span class="nav-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
        ...
        <!-- Auditoría -->
        <li class="nav-item">
          <a class="nav-link" href="../src/pages/auditoria.html">
            <span class="nav-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
    ...
    <div class="offcanvasNav offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample"
      ...
      <div class="offcanvas-header">
        ...
        <a class="d-flex align-items-center gap-2" href="../index.php">
          <img src="../src/assets/images/brand/logo/logo-icon.svg" alt="" />
      ...
      <div class="offcanvas-body p-0">
        <ul class="navbar-nav flex-column  ">
          <!-- Nav item -->
          <li class="nav-item">
            <a class="nav-link" href="./index.php"><span class="nav-icon"><svg xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div class="d-flex justify-content-between">
                    ...
                    <div>
                      <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24"
                        fill="currentColor" class="icon icon-tabler icons-tabler-filled icon-tabler-circle text-info">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
  ...
  <body>
    <p class="text-center">© All rights reserved by <a href="https://codescandy.com" target="_blank">CodesCandy</a>.
